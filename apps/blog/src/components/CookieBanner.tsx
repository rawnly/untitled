...
export default function CookieBanner() {
  ...
  const [isVisible, setIsVisible] = useState(() => window.localStorage.getItem('cookie_banner_accepted') !== 'true' && posthog.getFeatureFlag('cookie_banner_enabled') === 'with_banner')
